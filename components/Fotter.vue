  ...
  <div class="bg-[#f5f5f5] py-[64px]">
    <div class="max-w-[1440px] m-auto">
      ...
      >
        ...
        <div class="">
          <div class="contact">
            <div class="contact-control flex">
              <svg
                class="mr-2"
                width="24"
                height="24"
              ...
              <div class="mail-control mb-6">
                <NuxtLink to="email:utkirbektoirov1@gmail.com"
                  ><div class="mail">hello@enter.uz</div></NuxtLink
                >
                <div class="mail__description">
                  Пишите нам с любыми вопросами
                </div>
              </div>
            </div>
            <div class="contact-control flex">
              ...
              <div class="mail-control mb-6">
                <NuxtLink to="tel:998905376768"
                  ><div class="mail">+998 90 537 67 68</div></NuxtLink
                >
                <div class="mail__description">
            ...
            <div class="messengers flex gap-4">
              <NuxtLink to="/"
                ><svg
                  width="24"
                  height="24"
        ...
        <div class="">
          <ul class="sitemap-list">
            <div class="sitemap__title">Все курсы</div>
            <li class="sitemap__item">
              <NuxtLink to="/">IT-грамотность</NuxtLink>
            </li>
            <li class="sitemap__item">
              <NuxtLink to="/">Программирование</NuxtLink>
            </li>
            <li class="sitemap__item"><NuxtLink to="/">Дизайн</NuxtLink></li>
            <li class="sitemap__item"><NuxtLink to="/">Маркетинг</NuxtLink></li>
          </ul>
        </div>
        <div class="">
          <ul class="sitemap-list">
